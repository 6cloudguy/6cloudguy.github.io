...
description: Writeup for the VulnHub VM "Me and My Girlfriend 1"
---
## Box Description
...
![img](/assets/VulnHub/menmygf1/arp.png)\
Found the IP: `192.168.122.3`

## Step 1: Nmap Scan
Performed an Nmap scan:  
![img](/assets/VulnHub/menmygf1/nmap.png)\
...
![img](/assets/VulnHub/menmygf1/site.png)\
**Tip:** Always check source code of pages.  
Found a hidden message in the source:  
![img](/assets/VulnHub/menmygf1/sourcecode.png)\
...
![img](/assets/VulnHub/menmygf1/alice.png)\
Modified input type using browser dev tools and revealed password: `4lic3`  
![img](/assets/VulnHub/menmygf1/inspect.png)
![img](/assets/VulnHub/menmygf1/4lic3.png)

## Step 6: SSH Access
Since SSH was running, tried Alice’s creds:  
![img](/assets/VulnHub/menmygf1/ssh.png)\
...
![img](/assets/VulnHub/menmygf1/flag2.png)\
