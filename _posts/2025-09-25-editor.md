...
![img](/assets/HTB/editor/xwikiversion.png)\
After googling found that there is an RCE vuln available for it through the `Solrsearch` macro.\
![img](/assets/HTB/editor/xwikigoogle.png)\
![img](/assets/HTB/editor/cve.png)\
...
![img](/assets/HTB/editor/solrcmd.png)\
Then i pasted that in the url here:\
![img](/assets/HTB/editor/solrurl.png)\
...
\
![img](/assets/HTB/editor/llndsudo.png)\
...
![img](/assets/HTB/editor/ndsudoh.png)\
...
![img](/assets/HTB/editor/nanonvme.png)\
Now lets start a python server to send it to `editor`\
`python3 -m http.server`\
![img](/assets/HTB/editor/pyth.png)\
Now lets get that `nvme`.\
![img](/assets/HTB/editor/wget.png)\
![img](/assets/HTB/editor/llnvme.png)\
After doing checks and giving permissions, lets run it.\
![img](/assets/HTB/editor/root.png)\
