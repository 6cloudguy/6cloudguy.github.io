...
![img](/assets/HTB/strutted/struts.png)\
...
![img](/assets/HTB/strutted/testburp.png)\
...
![img](/assets/HTB/strutted/gif.png)\
...
![img](/assets/HTB/strutted/path.png)\
...
```
![img](/assets/HTB/strutted/upldfilenme.png)\
...
![img](/assets/HTB/strutted/succsfl.png)\
Nice, the upload was successful. Now lets check the file format.\
![img](/assets/HTB/strutted/txtpath.png)\
...
![img](/assets/HTB/strutted/rce.png)\
I found this nice PoC and so I cloned it into my attackbox.\
![img](/assets/HTB/strutted/git.png)\
Install the requirements if needed.\
However, we need to change some things in the exploit.py to work because of the upload restrictions and the parents in the upload file path.\
Change the `NO_OF_PARENTS_IN_PATH` to 5
```python
...
![img](/assets/HTB/strutted/etc.png)\
Now lets look for the creds for `james`\
![img](/assets/HTB/strutted/pass.png)\
And inside the `tomcat-users.xml`, I found a password for `admin`. \
![img](/assets/HTB/strutted/admin.png)\
I tried that password for `james` in ssh and BOOM!.\
We got in...\
![img](/assets/HTB/strutted/ssh.png)
## Privilege escalation
With our foothold as `james`, lets check his sudo permissions.\
![img](/assets/HTB/strutted/sudo.png)\
And we can see that he can run tcpdump as root.\
Now with that, lets check [GTFOBins](https://gtfobins.github.io) and check the tcpdump section.\
![img](/assets/HTB/strutted/gtfo.png)\
...
```
![img](/assets/HTB/strutted/rootshell.png)\
